...
using ThirdPartyLayer.Models.Google.GoogleCalendar.Request;
using ThirdPartyLayer.Models.Google.GoogleCalendar.Response;
using ThirdPartyLayer.Models.Google.GoogleMeeting.Response;
using ThirdPartyLayer.Models.Google.GoogleOAuth.Response;
using ThirdPartyLayer.Models.Google;
using ThirdPartyLayer.Services.Interfaces;
using ThirdPartyLayer.Utils;
using Microsoft.AspNetCore.Authentication;

namespace ThirdPartyLayer.Services.Implements
{
